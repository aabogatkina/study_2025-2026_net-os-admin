...
![Перезагрузка правил межсетевого экрана с сохранением информации о состоянии, список доступных служб, список активных служб](image/6.png){#fig-007 width=70%}
...
![Проверка возможности перенаправления IPv4-пакетов в ядре системы](image/11.png){#fig-012 width=70%}
...
![Проверка входа в Интернет на клиенте](image/14.png){#fig-015 width=70%}
